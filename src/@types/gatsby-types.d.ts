...
type ProjectPostBySlugQueryVariables = Exact<{
  id: Scalars['String'];
  previousPostId: InputMaybe<Scalars['String']>;
  nextPostId: InputMaybe<Scalars['String']>;
}>;
...
type ProjectPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly templateKey: string | null, readonly date: string | null, readonly description: string | null, readonly image: { readonly absolutePath: string } | null } | null } | null, readonly previous: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null, readonly next: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null };
...
type CreatePagesQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly templateKey: string | null } | null }> } };
